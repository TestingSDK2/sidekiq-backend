...
func (c *authServiceClient) ValidateUser(ctx context.Context, in *ValidateUserRequest, opts ...grpc.CallOption) (*ValidateUserReply, error) {
	...
	err := c.cc.Invoke(ctx, "/auth.v1.AuthService/ValidateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) CreateJWTToken(ctx context.Context, in *CreateJWTTokenRequest, opts ...grpc.CallOption) (*CreateJWTTokenReply, error) {
	...
	err := c.cc.Invoke(ctx, "/auth.v1.AuthService/CreateJWTToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthService_ValidateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.v1.AuthService/ValidateUser",
	}
...
func _AuthService_CreateJWTToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.v1.AuthService/CreateJWTToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
