...
type UploadedFile struct {
	...
	FileNumber      string     `json:"fileNumber" bson:"fileNumber"`
	TotalFiles      string     `json:"totalFiles" bson:"totalFiles"`
	...
	StorageLocation string     `json:"storageLocation" bson:"storageLocation"`
	FileLocation    string     `json:"fileLocation"`
	URL             string     `json:"url"`
	Thumbs          Thumbnails `json:"thumbs"`
	FileProcStatus  string     `json:"fileProcStatus"`
...
func (b UploadedFile) ToMap() (dat map[string]interface{}) {
	d, _ := json.Marshal(b)
